...
const parseCliOptions = (userCliOptions) => {
    const apiOptions = { version: '1.0.18' };
...
export const cliSetup = (program) => program
    ...
    .addOption(new Option('--minimum-license-severity-level <level>', 'Set the minimum license severity level. Accepted options are: LOW, MEDIUM, HIGH and CRITICAL.')
